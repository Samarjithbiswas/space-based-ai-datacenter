...
def fig_power():
    ...
    a.set_title("(a) Array area vs load (EOL, 70 C)")
    yrs = np.arange(0, 6)
    ...
    b.set_title("(b) Triple-junction degradation"); b.legend(fontsize=8)
...
def fig_link_budget():
    ...
    a.set_title("(a) Why tight formation works")
    ...
    b.set_title("(b) Pointing-loss sensitivity"); b.legend(fontsize=8); b.set_ylim(0, 12)
...
def fig_reliability():
    ...
    a.set_title("(a) No on-orbit repair: R(t)"); a.legend(fontsize=8)
    ...
    b.set_title(f"(b) Spares buy availability (R5={p:.2f})")
...
def fig_compute_econ():
    ...
    a.set_title("(a) Cost of useful compute"); a.legend(fontsize=8); a.set_ylim(0, 60)
    ...
    b.set_ylabel("Usable compute (%)"); b.set_title("(b) Radiation throughput tax")
