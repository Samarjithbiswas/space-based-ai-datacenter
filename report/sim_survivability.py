...
axA.set_title("(a)"); axA.legend(loc="upper left",fontsize=8)
...
ax1.set_title("(a)"); ax1.legend(loc="upper right",fontsize=8)
...
ax2.set_title("(b)"); ax2.legend(fontsize=7.8,loc="upper right")
...
axA.set_title("(a)"); axA.legend(fontsize=8)
axB=fig.add_subplot(gs[1])
