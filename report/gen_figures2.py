...
a.set_title("(a) Eclipse-free above this beta")
...
b.set_ylabel("Eclipse fraction (%)"); b.set_title("(b) Eclipse fraction at 650 km")
...
a.set_title("(a) Earth view factor vs altitude")
...
b.set_title("(b) Albedo + Earth-IR + solar load"); b.legend(fontsize=8)
...
a.set_title("(a) Equilibrium temperature (4 m^2)")
...
b.set_title("(b) Hotter radiator, less area"); b.set_ylim(0, 2500)
...
a.set_title("(a) FSO power to hold 3 dB margin")
...
b.set_title("(b) Pointing-loss sensitivity"); b.legend(fontsize=8)
...
a.set_title("(a) Exponential reliability"); a.legend(fontsize=8)
...
b.set_ylabel("Capacity at 5 yr (%)"); b.set_title(f"(b) Spares vs availability (R5={p5:.2f})")
...
a.set_title("(a) Cost of useful compute"); a.legend(fontsize=8)
...
b.set_title("(b) LCOE vs launch price")
