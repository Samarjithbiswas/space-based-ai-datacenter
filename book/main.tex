...
% --- Headings (Springer-monograph style chapter openers) ---
\titleformat{\chapter}[display]
  {\sffamily}
  {\raggedright\large\bfseries\color{brandTeal}\MakeUppercase{\chaptertitlename}}
  {8pt}
  {\raggedright\fontsize{26}{30}\selectfont\bfseries\color{brandSlate}}
  [\vskip10pt{\color{brandTeal}\titlerule[1.5pt]}]
\titleformat{\section}
...
flagged. The accompanying software is open, validated by 108 automated
