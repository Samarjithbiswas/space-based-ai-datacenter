...
<title>Space-Based AI Data Centers: An Engineering Reading</title>
...
<div class="wrap">
  <div class="topline">
    <div class="kicker">Engineering study</div>
    <h1>Space-Based AI Data Centers: An Engineering Reading</h1>
    <p class="byline"><strong>Samarjith Biswas, PhD</strong></p>
    <p class="byline">Feasibility, survivability, and economics, from primary sources and open simulation</p>
  </div>
  {BODY}
</div>
</body>
